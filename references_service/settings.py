"""Django settings for references_service project.
...
SWAGGER_SETTINGS = {
    'DEFAULT_INFO': 'references_service.urls.swagger_info', 
...
ROOT_URLCONF = 'references_service.urls'
...
WSGI_APPLICATION = 'references_service.wsgi.application'
